...
OVERRIDES: dict[str, tuple[str, str]] = {
    ...
    "blender_asset_mill_measured_components_v1.py": ("REFERENCE_ONLY", "preview role is replaced by export_blender_measured_components_preview_v0.py consuming measured gameguy_asset_v0 JSON"),
    "blender_asset_mill_measured_components_v2.py": ("REFERENCE_ONLY", "preview role is replaced by export_blender_measured_components_preview_v0.py consuming measured gameguy_asset_v0 JSON"),

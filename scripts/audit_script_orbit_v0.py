...
OVERRIDES: dict[str, tuple[str, str]] = {
    ...
    "export_blender_measured_components_preview_v0.py": ("KEEP_CANONICAL", "adapter that consumes promoted measured_components_v0 source recipes"),
    ...
    "blender_asset_mill_measured_components_v1.py": ("REFERENCE_ONLY", "preview role is replaced by export_blender_measured_components_preview_v0.py consuming measured_components_v0 source"),
    "blender_asset_mill_measured_components_v2.py": ("REFERENCE_ONLY", "preview role is replaced by export_blender_measured_components_preview_v0.py consuming measured_components_v0 source"),

...
OVERRIDES: dict[str, tuple[str, str]] = {
    ...
    "serve_pattern_selection_studio_v0.py": ("KEEP_CANONICAL", "local source-authoring studio that turns deterministic segment JSON into manual selection recipe JSON"),
    ...
    "execute_asset_polish_blender_adapter_v0.py": ("KEEP_CANONICAL", "adapter that consumes asset_polish_tool_plan_v0 plus gameguy_asset_v0 and executes only the first supported polish steps"),
    "export_asset_polish_joined_v0.py": ("KEEP_CANONICAL", "adapter that consumes completed asset polish Blender execution output and joins/exports the polished mesh"),
    ...
    "validate_asset_polish_blender_execution_report_v0.py": ("KEEP_CANONICAL", "guards asset_polish_tool_plan_v0 Blender execution reports without importing Blender"),
    "validate_asset_polish_join_export_report_v0.py": ("KEEP_CANONICAL", "guards completed asset polish join/export reports without importing Blender"),

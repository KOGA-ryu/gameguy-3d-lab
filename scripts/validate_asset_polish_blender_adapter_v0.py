...
SUPPORTED_OPERATIONS = {"bevel_edges", "chamfer_edges", "material_assign", "weighted_normals"}
SUPPORTED_TOOLS = {"material_assign_by_part", "modifier_bevel", "modifier_weighted_normal"}
FUTURE_OPERATIONS = {"boolean_cut", "extrude_along_normals", "inset_faces", "sweep_profile", "uv_unwrap"}
FUTURE_TOOLS = {"curve_bevel_profile", "extrude_faces", "inset_faces", "modifier_boolean", "uv_smart_project", "uv_unwrap"}
...
FIRST_EXECUTION_SELECTOR_KINDS = {"all_visible_hard_edges", "all_visible_mesh_parts", "edge_role", "part_ids"}

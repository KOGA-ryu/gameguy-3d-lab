...
class ScriptOrbitAuditTests(unittest.TestCase):
    def test_audit_classifies_known_core_scripts(self) -> None:
        ...
        self.assertEqual(rows["scripts/execute_asset_polish_blender_adapter_v0.py"]["bucket"], "KEEP_CANONICAL")
        self.assertEqual(rows["scripts/export_asset_polish_joined_v0.py"]["bucket"], "KEEP_CANONICAL")
        ...
        self.assertEqual(rows["scripts/validate_asset_polish_blender_execution_report_v0.py"]["bucket"], "KEEP_CANONICAL")
        self.assertEqual(rows["scripts/validate_asset_polish_join_export_report_v0.py"]["bucket"], "KEEP_CANONICAL")
        ...
        self.assertEqual(rows["scripts/validate_generation_pipeline_v0.py"]["bucket"], "KEEP_CANONICAL")
        self.assertEqual(rows["scripts/validate_reference_dissection_packet_v0.py"]["bucket"], "KEEP_CANONICAL")
        self.assertEqual(rows["scripts/validate_blender_tool_plan_execution_report_v0.py"]["bucket"], "KEEP_CANONICAL")
        self.assertEqual(rows["scripts/validate_gameguy_tool_plan_v0.py"]["bucket"], "KEEP_CANONICAL")
        ...
        self.assertEqual(rows["scripts/serve_pattern_selection_studio_v0.py"]["bucket"], "KEEP_CANONICAL")
        ...
        self.assertNotIn("scripts/compile_asset_mill_measured_components_v1.py", rows)
        self.assertNotIn("scripts/compile_asset_mill_measured_components_v2.py", rows)

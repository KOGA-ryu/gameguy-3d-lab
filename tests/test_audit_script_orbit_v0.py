...
class ScriptOrbitAuditTests(unittest.TestCase):
    def test_audit_classifies_known_core_scripts(self) -> None:
        ...
        self.assertEqual(rows["scripts/blender_asset_mill_smoke_test_v0.py"]["bucket"], "CONVERT_TO_ADAPTER")
        self.assertEqual(rows["scripts/compile_asset_mill_solids_v0.py"]["bucket"], "REFERENCE_ONLY")
        self.assertEqual(rows["scripts/compile_asset_mill_measured_components_v1.py"]["bucket"], "REPLACE_BY_PUMP")

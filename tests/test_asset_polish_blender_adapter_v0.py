...
class AssetPolishBlenderAdapterValidationTests(unittest.TestCase):
    def test_validate_only_reports_supported_and_future_steps(self) -> None:
        ...
        self.assertEqual(report["supported_step_count"], 10)
        self.assertEqual(report["future_step_count"], 0)
        ...
        self.assertFalse(any(row["adapter_status"] == "future" for row in report["operation_reports"]))
    ...
    def test_executor_validate_only_consumes_plan_and_asset(self) -> None:
        ...
        self.assertEqual(report["skipped_future_step_count"], 0)
